...
#define DRIVER_AUTHOR "TVM Hung, PHP Duy, NV Huy"
#define DRIVER_DESC "This module kernel is used generated a random number, and It allows user read and open its number"
#define DRIVER_VERSION "ver1"
